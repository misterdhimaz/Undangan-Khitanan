...
<head>
    ...
    <style>
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb { background: #B48E43; border-radius: 5px; }
...
<body class="bg-gray-100 antialiased overflow-x-hidden">
    ...
    <div class="w-full max-w-[550px] mx-auto min-h-screen bg-white shadow-2xl relative">
        ...
        <main id="royal-content" class="w-full pb-10 relative overflow-hidden bg-gradient-to-b from-[#F0FDF4] via-white to-[#F0FDF4]">
            ...
            <div class="absolute top-0 right-0 w-32 sm:w-48 h-32 sm:h-48 z-10 pointer-events-none opacity-40 mix-blend-multiply rotate-90">
                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><path fill="#047857" d="M0 0 L150 0 Q75 75 0 150 Z" /><path fill="none" stroke="#B48E43" stroke-width="2" d="M10 10 L130 10 Q70 70 10 130 Z"/></svg>
            </div>
            ...
            <section class="relative pt-10 pb-20 px-4 sm:px-6 text-center bg-white rounded-b-[60px] sm:rounded-b-[80px] shadow-xl z-20 overflow-hidden border-b-4 border-[#B48E43]/20">
                ...
                <div class="absolute top-0 right-8 sm:right-12 animate-[swing_4s_ease-in-out_infinite] origin-top" style="animation-delay: 1s">
                    <div class="w-[1px] h-28 sm:h-32 bg-[#B48E43]/60 mx-auto"></div>
                ...
                <h2 class="font-decor text-3xl sm:text-5xl font-bold text-[#064E3B] mb-4 leading-snug" data-aos="fade-up">
                    Assalamu’alaikum <br>
                    <span class="font-body font-medium text-lg sm:text-2xl mt-2 block text-[#B48E43]">Warahmatullahi Wabarakatuh</span>
                </h2>

                <p class="font-body text-gray-600 leading-relaxed mb-10 max-w-lg mx-auto text-sm sm:text-lg font-light px-2" data-aos="fade-up" data-aos-delay="100">
            ...
            <section class="py-16 sm:py-20 px-4 sm:px-6 relative z-10">
                <div class="text-center mb-12" data-aos="fade-down">
                    ...
                    <div class="inline-block px-6 py-2 rounded-full bg-[#064E3B]/5 border border-[#064E3B]/10">
                        <p class="text-gray-600 font-medium italic text-xs sm:text-sm">InsyaAllah Diselenggarakan Pada:</p>
                    </div>
                </div>
            ...
            {{-- 5. TURUT MENGUNDANG --}}
            <section class="py-16 sm:py-20 px-4 sm:px-6 bg-white relative z-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 relative z-10">
                        ...
                        <div class="space-y-4 sm:space-y-6" data-aos="fade-left" data-aos-delay="100">
                            ...
                            <div class="mt-6 p-4 bg-gray-50 rounded-xl text-center border border-gray-200">
                                <p class="text-gray-500 italic text-xs sm:text-sm font-medium">Segenap Keluarga Besar & Panitia</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{-- 7. DOA & DUKUNGAN (STACKED) --}}
            <section class="py-16 sm:py-24 px-4 sm:px-6 relative z-10 bg-white">
                <h2 class="text-center font-decor text-3xl sm:text-5xl text-[#064E3B] mb-10 sm:mb-16 drop-shadow-sm" data-aos="fade-down">Doa & Dukungan</h2>

                <div class="flex flex-col gap-6 sm:gap-10 max-w-sm mx-auto">
                    {{-- Card Hadiah --}}
                    <div class="royal-glass p-6 sm:p-8 rounded-[35px] sm:rounded-[45px] text-center border-2 border-[#FDE68A] relative overflow-hidden group shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105" data-aos="fade-up">
                        <div class="relative z-10">
                            <div class="w-20 h-20 sm:w-24 sm:h-24 mx-auto bg-[#FEF3C7] rounded-full flex items-center justify-center text-[#D97706] text-3xl sm:text-4xl mb-4 sm:mb-6 shadow-inner border border-[#D97706]/20">
                                <i class="fa-solid fa-gift animate-pulse"></i>
                            </div>
                            <h3 class="font-royal text-2xl sm:text-3xl mb-3 text-[#B48E43]">Kirim Hadiah</h3>
                            <p class="text-xs sm:text-sm text-gray-600 mb-6 sm:mb-8 leading-relaxed px-2">Doa restu Anda adalah hadiah terindah. Namun jika memberi adalah ungkapan kasih, kami menerimanya dengan senang hati.</p>
                            <button onclick="openModal('gift-modal')" class="w-full py-3 sm:py-4 rounded-full bg-gradient-to-r from-[#D97706] to-[#B45309] text-white font-bold text-base sm:text-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-3 cursor-pointer">
                                <i class="fa-solid fa-envelope-open-text text-lg sm:text-xl"></i> Amplop Digital
                            </button>
                        </div>
                    </div>

                    {{-- Card RSVP --}}
                    <div class="royal-glass p-6 sm:p-8 rounded-[35px] sm:rounded-[45px] text-center border-2 border-[#A7F3D0] relative overflow-hidden group shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105" data-aos="fade-up" data-aos-delay="100">
                        <div class="relative z-10">
                            <div class="w-20 h-20 sm:w-24 sm:h-24 mx-auto bg-[#D1FAE5] rounded-full flex items-center justify-center text-[#064E3B] text-3xl sm:text-4xl mb-4 sm:mb-6 shadow-inner border border-[#064E3B]/20">
                                <i class="fa-solid fa-clipboard-check animate-pulse"></i>
                            </div>
                            <h3 class="font-royal text-2xl sm:text-3xl mb-3 text-[#064E3B]">Konfirmasi</h3>
                            <p class="text-xs sm:text-sm text-gray-600 mb-6 sm:mb-8 leading-relaxed px-2">Mohon konfirmasi kehadiran Anda agar kami dapat mempersiapkan acara dengan sebaik-baiknya.</p>
                            <button onclick="openModal('rsvp-modal')" class="w-full py-3 sm:py-4 rounded-full bg-gradient-to-r from-[#059669] to-[#047857] text-white font-bold text-base sm:text-lg shadow-lg hover:shadow-xl transition flex items-center justify-center gap-3 cursor-pointer">
                                <i class="fa-solid fa-check-circle text-lg sm:text-xl"></i> Isi Form RSVP
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="royal-glass p-6 sm:p-12 rounded-[40px] sm:rounded-[50px] border border-white shadow-xl max-w-2xl mx-auto" data-aos="fade-up">
                    ...
                    @if (session('success_wish'))
                        <div class="mb-8 p-4 bg-[#D1FAE5] text-[#064E3B] rounded-2xl border border-[#10B981] flex items-center gap-3 animate-pulse">
                            ...
                            <span class="font-medium text-sm">{{ session('success_wish') }}</span>
                        </div>
                    @endif

                    <form action="{{ route('invitation.wish') }}" method="POST" class="space-y-4 sm:space-y-6">
                        @csrf
                        <div class="group">
                            <label class="text-xs sm:text-sm font-bold text-[#B48E43] uppercase ml-4 mb-2 block tracking-wider">Nama Anda:</label>
                            <input type="text" name="sender_name_wish" required value="{{ $guest->name ?? '' }}" class="w-full bg-white border border-gray-200 rounded-2xl py-3 sm:py-4 px-6 focus:outline-none focus:border-[#B48E43] focus:ring-4 focus:ring-[#FEF3C7] transition-all font-medium text-base sm:text-lg shadow-sm">
                        </div>
                        <div class="group">
                            <label class="text-xs sm:text-sm font-bold text-[#B48E43] uppercase ml-4 mb-2 block tracking-wider">Ucapan & Doa:</label>
                            <textarea name="message_wish" rows="4" required class="w-full bg-white border border-gray-200 rounded-2xl py-3 sm:py-4 px-6 focus:outline-none focus:border-[#B48E43] focus:ring-4 focus:ring-[#FEF3C7] transition-all font-medium text-base sm:text-lg shadow-sm"></textarea>
                        </div>
                        <button type="submit" class="w-full py-3 sm:py-4 rounded-full bg-gradient-to-r from-[#B48E43] to-[#92400E] text-white font-bold text-base sm:text-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-3 cursor-pointer">
                ...
                <div class="mt-12 sm:mt-16 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="space-y-4 sm:space-y-5 max-h-[400px] sm:max-h-[500px] overflow-y-auto pr-2 sm:pr-4 custom-scrollbar">
                        @forelse ($wishes as $wish)
                            <div class="bg-white p-5 sm:p-6 rounded-[25px] sm:rounded-[30px] border-l-8 border-[#10B981] shadow-sm hover:shadow-md transition-all relative">
                                <i class="fa-solid fa-quote-right absolute top-4 sm:top-6 right-4 sm:right-6 text-3xl sm:text-4xl text-gray-100"></i>
                                <div class="flex justify-between items-center mb-2 sm:mb-3 relative z-10">
                                    <h4 class="font-bold text-base sm:text-lg text-[#064E3B] flex items-center gap-2"><i class="fa-solid fa-circle-user text-[#10B981]"></i> {{ $wish->sender_name }}</h4>
                                    <span class="text-[10px] sm:text-xs text-[#064E3B] bg-[#D1FAE5] px-2 sm:px-3 py-1 rounded-full font-bold">{{ $wish->created_at->diffForHumans() }}</span>
                                </div>
                                <p class="text-gray-700 italic leading-relaxed pl-6 sm:pl-8 relative z-10 text-sm sm:text-base">"{{ $wish->message }}"</p>
                            </div>
                        @empty
                            <div class="text-center p-8 sm:p-10 bg-white/60 rounded-[30px] border-2 border-dashed border-gray-300">
                                <p class="text-gray-500 font-medium text-base sm:text-lg">Belum ada ucapan.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
            ...
            {{-- 9. FOOTER & MAP --}}
            <section class="pt-32 sm:pt-40 px-4 sm:px-6 pb-16 sm:pb-20 bg-[#022c22] text-center text-white relative rounded-t-[60px] sm:rounded-t-[80px] overflow-hidden z-20 -mt-12 sm:-mt-16 border-t-8 border-[#B48E43]/50">
                ...
                <div class="relative z-10 max-w-3xl mx-auto">
                    <h2 class="font-royal text-3xl sm:text-5xl text-[#FDE68A] mb-8 sm:mb-12 drop-shadow-sm">Lokasi Acara</h2>
                    ...
                    <div class="p-2 sm:p-4 bg-gradient-to-br from-[#B48E43] via-[#FDE68A] to-[#B48E43] rounded-[30px] sm:rounded-[45px] shadow-2xl mb-8 sm:mb-12 transform hover:rotate-1 transition-transform duration-500">
                        <div class="rounded-[25px] sm:rounded-[38px] overflow-hidden h-[300px] sm:h-[400px] relative border-4 border-[#022c22] shadow-inner bg-gray-200">
                            ...
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!4v1765938082968!6m8!1m7!1sI3SrbYWfmU314ZLzbW014Q!2m2!1d-3.327979000083336!2d102.0266683010595!3f202.03310844743407!4f-22.3281287654616!5f0.7820865974627469"
                                width="100%"
                                height="100%"
                                style="border:0;"
                                allowfullscreen=""
                    ...
                    <a href="https://maps.app.goo.gl/aKd1VkjJBpiaodaV8" target="_blank" class="inline-flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-[#B48E43] to-[#D97706] text-white px-8 sm:px-12 py-4 sm:py-5 rounded-full font-bold text-lg sm:text-xl shadow-xl shadow-[#B48E43]/40 hover:shadow-2xl hover:scale-105 transition-all group mb-12 sm:mb-20 border-2 border-[#FDE68A]/50">
                        <i class="fa-solid fa-map-location-dot text-xl sm:text-2xl group-hover:animate-wiggle"></i> Buka di Google Maps
                    </a>

                    <div class="max-w-md mx-auto border-t border-white/10 pt-8 sm:pt-10">
                        <h1 class="font-script text-3xl sm:text-4xl text-[#FDE68A] mb-4 sm:mb-6 drop-shadow-sm font-royal">Muhammad Wahid Arsyaka Family</h1>
                        <p class="text-[#D1FAE5]/80 text-xs sm:text-sm mb-8 sm:mb-10 leading-relaxed font-light px-4">
                            Atas kehadiran dan doa restu Bapak/Ibu/Saudara/i, <br> kami ucapkan terima kasih yang sebesar-besarnya.
                        </p>
                        <div class="text-[#D1FAE5]/50 text-[10px] sm:text-xs flex items-center justify-center gap-2 bg-[#064E3B]/50 py-2 sm:py-3 rounded-full mx-auto w-fit px-6 sm:px-8 border border-white/5">
        ...
        <div id="gift-modal" class="modal-overlay fixed inset-0 z-[9999] hidden flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div class="modal-content bg-[#F0FDF4] w-full max-w-sm rounded-[35px] p-6 sm:p-8 relative border-4 border-[#D97706] shadow-2xl overflow-y-auto max-h-[90vh]">
                ...
                <div class="text-center mb-6 sm:mb-8">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto bg-[#FEF3C7] rounded-full flex items-center justify-center text-[#D97706] text-3xl sm:text-4xl mb-3 sm:mb-4 shadow-inner border border-[#D97706]/30">
                        <i class="fa-solid fa-gift"></i>
                    </div>
                    <h3 class="font-decor font-bold text-xl sm:text-2xl text-[#B48E43] mb-2">Amplop Digital</h3>
                    <p class="text-xs sm:text-sm text-gray-500 leading-relaxed">Silakan transfer tanda kasih Anda melalui rekening berikut:</p>
                </div>
        ...
        <div id="rsvp-modal" class="modal-overlay fixed inset-0 z-[9999] hidden flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div class="modal-content bg-[#F0FDF4] w-full max-w-sm rounded-[35px] p-6 sm:p-8 relative border-4 border-[#064E3B] shadow-2xl overflow-y-auto max-h-[90vh]">
                ...
                <div class="text-center mb-6 sm:mb-8">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto bg-[#D1FAE5] rounded-full flex items-center justify-center text-[#064E3B] text-3xl sm:text-4xl mb-3 sm:mb-4 shadow-inner border border-[#064E3B]/30">
                        <i class="fa-solid fa-clipboard-check"></i>
                    </div>
                    <h3 class="font-decor font-bold text-xl sm:text-2xl text-[#064E3B] mb-2">Konfirmasi</h3>
                    <p class="text-xs sm:text-sm text-gray-500 leading-relaxed">Mohon isi data kehadiran Anda di bawah ini.</p>
                </div>

                <form action="{{ route('invitation.rsvp') }}" method="POST" class="space-y-4 sm:space-y-5">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <select name="status_rsvp" id="status_rsvp_modal" class="w-full p-3 sm:p-4 bg-white border-2 border-[#A7F3D0] rounded-2xl focus:outline-none focus:border-[#064E3B] font-medium text-sm sm:text-base">
